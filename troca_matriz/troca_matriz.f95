...
PROGRAM troca_matriz
	...
	USE MPI
		...
		INTEGER :: jsta,jend,jsta2,jend2,inext,iprev, isend1, isend2,isend3, isend4, irecv1, irecv2, irecv3, irecv4
...
! Initializing MPI
		...
		CALL MPI_ISEND(a(1,jend-1), m, MPI_REAL8, inext, 1, MPI_COMM_WORLD, isend3, ierr)
		CALL MPI_ISEND(a(1,jsta+1), m, MPI_REAL8, iprev, 1, MPI_COMM_WORLD, isend4, ierr)
		...
		CALL MPI_IRECV(a(1,jsta-2), m, MPI_REAL8, iprev, 1, MPI_COMM_WORLD, irecv3, ierr)
		CALL MPI_IRECV(a(1,jend+2), m, MPI_REAL8, inext, 1, MPI_COMM_WORLD, irecv4, ierr)
		...
		IF (myid.eq.0) THEN
			open (unit=10, file='result_paralelo.dat', ACCESS='direct', recl=4*n*m, status='UNKNOWN')
